...
Prime-number checking project written in **MIPS Assembly** 🖥️, with reference implementations in **C++** 💻 and **Python** 🐍.
...
2. ⚙️ Assemble
3. ▶️ Run
4. ⌨️ Enter an integer when prompted
